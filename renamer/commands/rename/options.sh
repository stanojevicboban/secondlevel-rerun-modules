...
# Created: Wed  6 Mar 2013 14:39:20 EST
#
#/ usage: renamer:rename [ --from <skeletor>]  --to <> [ --repo <>] 
...
rerun_options_parse() {
    ...
    [ -z "$REPO" ] && REPO="$(rerun_property_get $RERUN_MODULE_DIR/options/repo DEFAULT)"
